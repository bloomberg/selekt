...
internal class JdbcConnection(
    ...
    override fun prepareStatement(
        ...
        checkClosed()
        when (autoGeneratedKeys) {
            Statement.NO_GENERATED_KEYS -> Unit
            Statement.RETURN_GENERATED_KEYS -> addWarning(
                SQLWarning(
                    "SQLite does not support retrieval of auto-generated keys via PreparedStatement; " +
                        "use SELECT last_insert_rowid() instead."
                )
            )
            else -> throw SQLException(
                "Invalid autoGeneratedKeys value: $autoGeneratedKeys " +
                    "(expected NO_GENERATED_KEYS or RETURN_GENERATED_KEYS)"
            )
        }
    ...
    override fun prepareStatement(
        ...
        if (columnIndexes.isNotEmpty()) {
            addWarning(
                SQLWarning("SQLite does not support retrieval of auto-generated keys by column index; ignoring.")
            )
        }
        return prepareStatement(sql)
    }
    ...
    override fun prepareStatement(
        ...
        if (columnNames.isNotEmpty()) {
            addWarning(
                SQLWarning("SQLite does not support retrieval of auto-generated keys by column name; ignoring.")
            )
        }
        return prepareStatement(sql)
    }
