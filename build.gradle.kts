    ...
    violationRules {
        rule {
            ...
            limit {
                counter = "LINE"
                value = "COVEREDRATIO"
                minimum = "0.9645".toBigDecimal() // Does not include inlined blocks. Jacoco can't yet cover these.
            }
            limit {
                counter = "BRANCH"
                value = "COVEREDRATIO"
                minimum = "0.8847".toBigDecimal() // Does not include inlined blocks. Jacoco can't yet cover these.
            }
        }
    }
