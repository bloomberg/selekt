...
internal class TieredObjectPoolTest {
    ...
    private val factory: IObjectFactory<PooledObject> = mock()
    private val pool = TieredObjectPool(singleObjectPool, commonObjectPool, factory)
    ...
    @Test
    fun gauge() {
        whenever(factory.gauge()) doReturn FactoryGauge(5, 1)
        pool.gauge().let {
            verify(factory, times(1)).gauge()
