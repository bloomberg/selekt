...
internal class Mutex {
    ...
    private companion object {
        ...
        val isLockedUpdater = requireNotNull(AtomicIntegerFieldUpdater.newUpdater(Mutex::class.java, IS_LOCKED))

        const val IS_CANCELLED = "isCancelled"
        val isCancelledUpdater = requireNotNull(AtomicIntegerFieldUpdater.newUpdater(Mutex::class.java, IS_CANCELLED))

        private fun cancellationError(): Nothing = error("Mutex received cancellation signal.")
    }
}
