...
public class ExternalSQLiteTextBatchReadBenchmark {
    ...
    public void setUp() {
        ...
        final String sql = "SELECT " + String.join(",", Collections.nCopies(columnCount, "?"));
    ...
    @Benchmark
    public int readIndependently() {
        for (int index = 0; index < columnCount; ++index) {
            destination[index] = SQLITE.columnText(statement, index);
        }
        return Arrays.hashCode(destination);
    }
