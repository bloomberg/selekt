...
enum class Versions(
    ...
    ANDROID_GRADLE_PLUGIN("7.2.0", URL("https://developer.android.com/tools/revisions/gradle-plugin.html")),
    ...
    KOTLIN_TEST("1.6.21", URL("https://github.com/JetBrains/kotlin")),
