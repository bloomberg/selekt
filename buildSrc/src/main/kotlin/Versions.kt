...
enum class Versions(
    ...
    ANDROID_GRADLE_PLUGIN("7.0.1", URL("https://developer.android.com/tools/revisions/gradle-plugin.html")),
    ...
    ROBOLECTRIC("4.6.1", URL("https://github.com/robolectric/robolectric"));
