...
enum class Versions(
    ...
    ANDROID_GRADLE_PLUGIN("7.3.1", URL("https://developer.android.com/tools/revisions/gradle-plugin.html")),
    ...
    ANDROIDX_ROOM("2.4.3", URL("https://developer.android.com/jetpack/androidx/releases/room")),
    ...
    JUNIT5("5.9.1", URL("https://junit.org/junit5/")),
    JUNIT5_PLATFORM("1.9.1", URL("https://junit.org/junit5/")),
    KOTLIN("1.8.0", URL("https://github.com/JetBrains/kotlin")),
    ...
    MOCKITO("4.11.0", URL("https://github.com/mockito/mockito")),
